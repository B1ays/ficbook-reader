...
import ru.blays.preferences.Interfaces.IDataStore
import kotlin.reflect.KProperty

abstract class BaseDataStore <T: Any> internal constructor (
    final override val dataStore: DataStore<Preferences>
): IDataStore<T> {
