...
object Patterns {
    ...
    val TOP_LEVEL_DOMAIN_STR = ("((aero|arpa|asia|a[cdefgilmnoqrstuwxz])" + "|(biz|b[abdefghijmnorstvwyz])"
    ...
    private val IP_ADDRESS_STRING = ("((25[0-5]|2[0-4][0-9]|[0-1][0-9]{2}|[1-9][0-9]|[1-9])\\.(25[0-5]|2[0-4]"
   ...
   */
    ...
    val WEB_URL = Pattern.compile(
        "(" + "(" + "(?:" + PROTOCOL + "(?:" + USER_INFO + ")?" + ")?" + "DOM" + DOMAIN_NAME_STR + "AIN_NAME_STR"
     ...
     */
    private val STRICT_TLD = "(?:$IANA_TOP_LEVEL_DOMAINS|$PUNYCODE_TLD)"
     ...
     * [.STRICT_HOST_NAME] or [.IP_ADDRESS]
     */
    private val STRICT_DOMAIN_NAME = "(?:$STRICT_HOST_NAME|$IP_ADDRESS_STRING)"
    ...
    private val WEB_URL_WITHOUT_PROTOCOL =
        ("(" + WORD_BOUNDARY + "(?<!:\\/\\/)" + "(" + "(?:" + STRICT_DOMAIN_NAME + ")" + "(?:"
                + PORT_NUMBER + ")?" + ")" + "(?:" + PATH_AND_QUERY + ")?" + WORD_BOUNDARY + ")")
    ...
    private val WEB_URL_WITH_PROTOCOL =
        ("(" + WORD_BOUNDARY + "(?:" + "(?:" + PROTOCOL + "(?:" + USER_INFO + ")?" + ")" + "(?:"
     ...
     * @hide
     */
    val AUTOLINK_WEB_URL = Pattern.compile("(" + WEB_URL_WITH_PROTOCOL + "|" + WEB_URL_WITHOUT_PROTOCOL + ")")
     ...
     * @hide
     */
    val AUTOLINK_EMAIL_ADDRESS = Pattern
     ...
     *  * Optionally, sets of digits in parentheses, separated by spaces, dots,
     * or dashes.
     *  * A string starting and ending with a digit, containing digits, spaces,
     * dots, and/or dashes.
     *
     */
